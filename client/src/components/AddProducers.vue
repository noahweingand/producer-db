...
<div class="pr-5 pl-5 mr-5 mt-5 pt-5 center">
    ...
    <div class="pr-5 pl-5 mr-5 ml-5 mt-5 pt-5">
    <b-form @submit="onSubmit" @reset="onReset" v-if="show">
      ...
      <b-form-group id="input-group-6" label="Wikipedia URL (optional):" label-for="input-6">
        <b-form-input
          id="input-6"
          v-model="form.wiki"
      ...
      <b-form-group id="input-group-7" label="Enter Instagram handle" label-for="input-7">
        <b-form-input
          id="input-7"
      ...
      <b-form-group id="input-group-8" label="Enter Twitter handle" label-for="input-8">
        <b-form-input
          id="input-8"
